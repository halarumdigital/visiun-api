...
const distratoResponseSchema = {
  ...
  properties: {
    ...
    modelo_moto: { type: 'string', nullable: true },
    data_distrato: { type: 'string', nullable: true },
    ...
    schema: {
      ...
      querystring: {
        ...
        properties: {
          ...
          limit: { type: 'number', minimum: 1, maximum: 5000, default: 20 },
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          rental_id: { type: ['string', 'null'], format: 'uuid' },
          termo_url: { type: ['string', 'null'] },
          client_name: { type: ['string', 'null'] },
          modelo_moto: { type: ['string', 'null'] },
          data_distrato: { type: ['string', 'null'] },
        },
      },
      response: {
        201: {
