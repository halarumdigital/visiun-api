    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          chassi: { type: ['string', 'null'], description: 'Número do chassi' },
          renavam: { type: ['string', 'null'], description: 'Número do RENAVAM' },
          modelo: { type: 'string', minLength: 1, description: 'Modelo da motocicleta' },
          marca: { type: ['string', 'null'], description: 'Marca da motocicleta' },
          ano: { type: ['number', 'null'], minimum: 1900, maximum: 2100, description: 'Ano de fabricação' },
          cor: { type: ['string', 'null'], description: 'Cor' },
          quilometragem: { type: ['number', 'null'], minimum: 0, description: 'Quilometragem atual' },
          codigo_cs: { type: ['string', 'null'], description: 'Código CS' },
          tipo: { type: ['string', 'null'], enum: ['Nova', 'Usada', null], description: 'Tipo da motocicleta' },
          valor_semanal: { type: ['number', 'null'], minimum: 0, description: 'Valor semanal' },
          city_id: { type: ['string', 'null'], format: 'uuid', description: 'ID da cidade' },
          franchisee_id: { type: ['string', 'null'], format: 'uuid', description: 'ID do franqueado' },
          franqueado: { type: ['string', 'null'], description: 'Nome do franqueado' },
          doc_moto: { type: ['string', 'null'], description: 'URL do documento da moto' },
          doc_taxa_intermediacao: { type: ['string', 'null'], description: 'URL do documento de taxa de intermediação' },
          observacoes: { type: ['string', 'null'], description: 'Observações' },
          data_ultima_mov: { type: ['string', 'null'], description: 'Data da última movimentação' },
        },
      },
      response: {
        201: {
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          ano: { type: ['number', 'null'], minimum: 1900, maximum: 2100 },
          cor: { type: ['string', 'null'] },
          quilometragem: { type: ['number', 'null'], minimum: 0 },
          codigo_cs: { type: ['string', 'null'] },
          tipo: { type: ['string', 'null'], enum: ['Nova', 'Usada', null] },
          valor_semanal: { type: ['number', 'null'], minimum: 0 },
          city_id: { type: ['string', 'null'], format: 'uuid' },
          franchisee_id: { type: ['string', 'null'], format: 'uuid' },
          franqueado: { type: ['string', 'null'] },
          doc_moto: { type: ['string', 'null'] },
          doc_taxa_intermediacao: { type: ['string', 'null'] },
          observacoes: { type: ['string', 'null'] },
          status: { type: 'string', enum: motorcycleStatusEnum },
          data_ultima_mov: { type: ['string', 'null'] },
        },
      },
      response: {
        200: {
